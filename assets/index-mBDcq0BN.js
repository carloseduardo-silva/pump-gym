...
`,en=e=>{const[t,n]=E.useState(!1),[r,i]=E.useState(!1),[s,o]=E.useState(!1),[a,l]=E.useState(!1),[c,f]=E.useState(!1),[m,g]=E.useState("white"),[v,y]=E.useState("absolute");return E.useEffect(()=>{switch(e.active){case"aluno":i(!0);break;case"contato":f(!0);break;case"modalidades":l(!0);break;case"unidades":o(!0);break}}),E.useEffect(()=>{const w=document.querySelector("div nav");switch(e.navSetting){case"white":g("black"),y("fixed"),w.classList.add("whiteNav");break;case"transparent":g("white"),y("absolute"),w.classList.remove("whiteNav");break}}),E.useEffect(()=>{switch(e.navPosition){case"fixed":y("fixed");break;case"absolute":y("absolute");break}}),u.jsxs(Nv,{className:"",navPosition:v,linkColor:m,children:[u.jsx(z,{to:"/pump-gym",children:u.jsxs(Ov,{children:[u.jsx("span",{children:"P"}),"  UM ",u.jsx("span",{children:"P"})]})}),u.jsxs(zv,{linkColor:m,children:[s?u.jsx(z,{style:{borderBottom:"2px solid rgb(240, 10, 10)"},to:"/pump-gym/unidades",children:" UNIDADES"}):u.jsx(z,{to:"/pump-gym/unidades",children:"UNIDADES"}),a?u.jsx(z,{style:{borderBottom:"2px solid rgb(240, 10, 10)"},to:"/pump-gym/modalidades",children:"MODALIDADES"}):u.jsx(z,{to:"/pump-gym/modalidades",children:" MODALIDADES"}),r?u.jsx(z,{style:{borderBottom:"2px solid rgb(240, 10, 10)"},to:"/pump-gym/aluno",children:" ÂREA DO ALUNO"}):u.jsx(z,{to:"/pump-gym/aluno",children:" ÂREA DO ALUNO"}),c?u.jsx(z,{style:{borderBottom:"2px solid rgb(240, 10, 10)"},to:"/pump-gym/contato",children:" FALE CONOSCO"}):u.jsx(z,{to:"/pump-gym/contato",children:" FALE CONOSCO"}),u.jsxs(z,{className:"matricula",style:{borderBottom:"none"},to:"/pump-gym/matricula",children:[u.jsx("span",{class:"material-symbols-outlined",children:"person_add"})," MATRICULE-SE"]})]}),u.jsxs(_v,{isVisible:t,children:[u.jsx("header",{children:u.jsx("span",{class:"material-symbols-outlined",onClick:()=>{n(!1)},children:"close"})}),u.jsxs(Rv,{children:[s?u.jsx(z,{style:{borderBottom:"2px solid rgb(240, 10, 10)"},to:"/unidades",children:" UNIDADES"}):u.jsx(z,{to:"/unidades",children:"UNIDADES"}),a?u.jsx(z,{style:{borderBottom:"2px solid rgb(240, 10, 10)"},to:"/modalidades",children:"MODALIDADES"}):u.jsx(z,{to:"/modalidades",children:" MODALIDADES"}),r?u.jsx(z,{style:{borderBottom:"2px solid rgb(240, 10, 10)"},to:"/aluno",children:" ÂREA DO ALUNO"}):u.jsx(z,{to:"/aluno",children:" ÂREA DO ALUNO"}),c?u.jsx(z,{style:{borderBottom:"2px solid rgb(240, 10, 10)"},to:"/contato",children:" FALE CONOSCO"}):u.jsx(z,{to:"/contato",children:" FALE CONOSCO"}),u.jsxs(z,{className:"matricula",style:{borderBottom:"none"},to:"/matricula",children:[u.jsx("span",{class:"material-symbols-outlined",children:"person_add"})," MATRICULE-SE"]})]})]}),u.jsx(Lv,{linkColor:m,children:u.jsx("span",{class:"material-symbols-outlined",onClick:()=>{n(!0)},children:"menu"})})]})},Dc=De`
    from{
        opacity: 0.25;
...
`,Lx=()=>{const[e,t]=E.useState("./contatoContainer.png");return u.jsx(Ax,{children:u.jsxs(Nx,{children:[u.jsx(z,{to:"/pump-gym/contato",children:u.jsxs(zx,{IMG:e,children:[u.jsx("h1",{children:"ENTRE EM CONTATO"}),u.jsx(z,{to:"/contato",children:"Contato"})]})}),u.jsx(z,{style:{animationDelay:"100ms"},to:"/pump-gym/matricula",children:u.jsxs(Ox,{children:[u.jsx("h1",{children:"VEJA OS NOSSOS PLANOS"}),u.jsx("p",{children:" Planos a partir de apenas  R$97.00 por mês"})]})})]})})},_x=_.footer`
display:flex;
flex-direction: column;
align-items:center;
justify-content:center;
